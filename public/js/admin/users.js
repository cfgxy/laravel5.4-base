...
startApp({
    'routes': [{ path: '/', component: __webpack_require__(236) }, { path: '/profile', component: __webpack_require__(237) }]
});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_fine_uploader__ = __webpack_require__(219);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    mounted: function mounted() {
        ...
        var options = {
            ...
            callbacks: {
                onComplete: function onComplete() {
                    var preview = $('#' + vm.uniqid + ' .main-preview', vm.$el);
        ...
        if (this.rectsize) {
            options.scaling = {
                sendOriginal: false,
                sizes: [{ name: "rect", maxSize: this.rectsize }]
            };
        }

        if (this.minres) {
            var minres = this.minres.split('x');
            this.validation.image.minWidth = _.parseInt(minres[0]);
            this.validation.image.minHeight = _.parseInt(minres[1]);
        }

        if (this.maxres) {
            var maxres = this.minres.split('x');
            this.validation.image.maxWidth = _.parseInt(maxres[0]);
            this.validation.image.maxHeight = _.parseInt(maxres[1]);
        }

        this.uploader = new __WEBPACK_IMPORTED_MODULE_0_fine_uploader__["FineUploader"](options);

        this.$on('preview', function (src) {});
    },
    ...
    methods: {
        preview: function preview(src) {
            ...
            var preview = $('#' + this.uniqid + ' .main-preview', this.$el);
...
/* harmony default export */ __webpack_exports__["default"] = ({
    data: function data() {
        ...
        return {
            ds: new APIPagerDatasource('./data', [{ headerName: "姓名", field: "name" }, { headerName: "角色", field: "roles", vis: true, cellRenderer: function cellRenderer(params) {
                    return params.value.reduce(function (s, v) {
                        return s + ", " + v.display_name;
                    }, '').substring(1);
                } }, { headerName: "邮箱", field: "email" }, { headerName: "创建日期", width: 150, field: "created_at" }], [{ name: 'act1', label: '动作1', icon: 'fa-bookmark', url: '/admin/tasks/#/{{id}}' }, { name: 'act2', label: '动作2', icon: 'fa-grav' }]).ajaxData(function (data) {
    ...
    methods: {
        ...
        onEdit: function onEdit() {
            var rows = this.$refs.grid.api.getSelectedNodes();
        ...
        onCreationSubmit: function onCreationSubmit(form) {
            var _this3 = this;
            ...
            axios.post('./data', obj).then(function (ret) {
                ...
                //表格内容更新，弹出框隐藏
                _this3.$refs.grid.pager.loadPage();
                _this3.$refs['model-creation'].hide();
            });
        },
        onUpdationShow: function onUpdationShow() {
            $('form[name="users.updation"]').fill(this.currentRow);
        },
        onUpdationSubmit: function onUpdationSubmit(form) {
            var _this4 = this;
            ...
            axios.put("./data/" + this.currentRow.id, obj).then(function (ret) {
                var msg = ret.data;
                ...
                _this4.$refs.grid.api.deselectAll();
                _this4.$refs.grid.pager.loadPage();
                _this4.$refs['model-updation'].hide();
            });
        },
...
/* harmony default export */ __webpack_exports__["default"] = ({
    components: {
        'avatar-uploader': __webpack_require__(235)
    },
    data: function data() {
        return {
            model: {},
            original: {},
            breadcrum: [appDashboardBreadcrumItem, makeAppBreadcrum('个人信息', './#' + this.$route.path, 'fa-user-circle')]
        };
    },
    ...
    mounted: function mounted() {
        ...
        axios.get('./profile').then(function (ret) {
            var msg = ret.data;
            if (msg.code === 0) {
                _this.original = _.cloneDeep(msg.data);
                _this.model = msg.data;
                vm.$refs.uploader.preview(!_this.model.has_avatar ? '' : _this.model.avatar);
            }
        });
        ...
        $('form[name="users.updation"]', this.$el).on('jsvalidator.ok', function () {
            ...
            var obj = dataDiff(vm.model, vm.original);

            if (!obj.password) {
                delete obj.password;
            }

            axios.put('./profile', obj).then(function (ret) {
                var msg = ret.data;

                if (msg.code === 422) {
                    $.addErrorStates(_this2, msg.data.errors);
                    return apperror(msg.msg);
                } else if (msg.code > 0) {
                    return apperror(msg.msg);
                }
...
exports.push([module.i, "\n\n.avatar-uploader {\n  height: 200px;\n  width: 200px;\n  padding: 0;\n  overflow: hidden;\n}\n.avatar-uploader .qq-drop-processing {\n    display: none;\n}\n.avatar-uploader:before {\n    top: 40%;\n}\n.avatar-uploader .qq-upload-button {\n    background: #333333;\n    opacity: 0.6;\n    border-radius: 0;\n    border: none;\n    box-shadow: none;\n    width: 100%;\n    margin-top: 162px;\n}\n.avatar-uploader .qq-upload-list {\n    display: none;\n}\n.avatar-uploader .qq-total-progress-bar-container {\n    position: absolute;\n    top: 0;\n    left: 0;\n    right: 0;\n    margin-left: 0;\n    width: 100%;\n}\n.avatar-uploader .qq-progress-bar {\n    height: 3px;\n    border-radius: 0;\n}\n.avatar-uploader .main-preview {\n    position: absolute;\n    left: 0;\n    right: 0;\n    top: 0;\n    width: 200px;\n}\n", ""]);
...
module.exports = "/images/vendor/fine-uploader/all.fine-uploader/edit.gif?1115b1192665d62c2c0fef7f2fb4f3b0";
...
module.exports = "/images/vendor/fine-uploader/all.fine-uploader/loading.gif?8480b8885e9c00b9397c8ce70424e317";
...
module.exports = "/images/vendor/fine-uploader/all.fine-uploader/processing.gif?7587869b1942e62c90a1df473a1b08f7";
...
var __WEBPACK_AMD_DEFINE_RESULT__;// Fine Uploader 5.14.2 - (c) 2013-present Widen Enterprises, Inc. MIT licensed. http://fineuploader.com
(function(global) {
...
Component.options.__file = "/Volumes/Data/Users/guxy/projects/laravel5.4-base/app/Features/Admin/vue/pages/users/AvatarUploader.vue.html"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] AvatarUploader.vue.html: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6425d8a4", Component.options)
  } else {
    hotAPI.reload("data-v-6425d8a4", Component.options)
  }
})()}
...
Component.options.__file = "/Volumes/Data/Users/guxy/projects/laravel5.4-base/app/Features/Admin/vue/pages/users/List.vue.html"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-ab1fc566", Component.options)
  } else {
    hotAPI.reload("data-v-ab1fc566", Component.options)
  }
})()}
...
Component.options.__file = "/Volumes/Data/Users/guxy/projects/laravel5.4-base/app/Features/Admin/vue/pages/users/Profile.vue.html"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key !== "__esModule"})) {console.error("named exports are not supported in *.vue files.")}
if (Component.options.functional) {console.error("[vue-loader] Profile.vue.html: functional components are not supported with templates, they should use render functions.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6e2a7ae4", Component.options)
  } else {
    hotAPI.reload("data-v-6e2a7ae4", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6425d8a4", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('panel', [_c('span', {
  ...
  }, [_vm._v("头像")]), _vm._v(" "), _c('avatar-uploader', {
    ref: "uploader",
    attrs: {
      "name": "avatar"
    },
    ...
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.model.email = $event.target.value
      }
    }
  })]), _vm._v(" "), _c('div', {
    staticClass: "form-group"
    ...
    staticClass: "control-label",
    attrs: {
      "for": "users-updation-password"
    }
  }, [_vm._v("密码(留空表示不修改)")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "control-label",
    attrs: {
      "for": "users-updation-password_confirmation"
    }
  }, [_vm._v("确认")]), _vm._v(" "), _c('input', {
    directives: [{
      name: "model",
      rawName: "v-model",
    ...
    staticClass: "form-control",
    attrs: {
      "id": "users-updation-password_confirmation",
      "name": "password_confirmation",
      "type": "password",
      "placeholder": "重复输入密码字段以确认"
    },
    domProps: {
      "value": (_vm.model.password_confirmation)
    },
    on: {
      "input": function($event) {
        if ($event.target.composing) { return; }
        _vm.model.password_confirmation = $event.target.value
      }
    }
  })])]), _vm._v(" "), _c('div', {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-6e2a7ae4", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('panel', [_c('span', {
    ...
    attrs: {
      "type": "button",
      "data-toggle": "modal",
      "data-target": "#model-creation"
    }
  }, [_vm._v("新增")]), _vm._v(" "), _c('span', {
    staticClass: "dropdown"
  }, [_c('button', {
    staticClass: "btn btn-app-mid btn-app-white btn-sm",
    attrs: {
      "type": "button",
    ...
    on: {
      "submit": _vm.onCreationSubmit
    }
  }, [_c('span', {
    slot: "title"
  }, [_vm._v("新增用户")]), _vm._v(" "), _c('div', {
    staticClass: "app-alert-content-wrapper",
    slot: "content"
  }, [_c('form', {
    ...
    staticClass: "col-sm-4 control-label",
    attrs: {
      "for": "model-creation-password_confirmation"
    }
    ...
    staticClass: "form-control",
    attrs: {
      "id": "model-creation-password_confirmation",
      "name": "password_confirmation",
      "type": "password",
      "placeholder": "重复输入密码字段以确认"
    }
    ...
    on: {
      "show": _vm.onUpdationShow,
      "submit": _vm.onUpdationSubmit
    }
  }, [_c('span', {
    slot: "title"
  }, [_vm._v("修改用户信息")]), _vm._v(" "), _c('div', {
    staticClass: "app-alert-content-wrapper",
    slot: "content"
  }, [_c('form', {
    staticClass: "form-horizontal",
    ...
    staticClass: "col-sm-4 control-label",
    attrs: {
      "for": "model-updation-password"
    }
  }, [_vm._v("密码(留空表示不修改)")]), _vm._v(" "), _c('div', {
    staticClass: "col-sm-8"
  }, [_c('input', {
    staticClass: "form-control",
    attrs: {
      "id": "model-updation-password",
      "name": "password",
      "type": "password",
      "placeholder": "输入密码"
    }
    ...
    staticClass: "col-sm-4 control-label",
    attrs: {
      "for": "model-updation-password_confirmation"
    }
  }, [_vm._v("确认")]), _vm._v(" "), _c('div', {
    staticClass: "col-sm-8"
  }, [_c('input', {
    staticClass: "form-control",
    attrs: {
      "id": "model-updation-password_confirmation",
      "name": "password_confirmation",
      "type": "password",
      "placeholder": "重复输入密码字段以确认"
    }
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-ab1fc566", module.exports)
  }
}
...
var update = __webpack_require__(117)("aeb19f52", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6425d8a4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AvatarUploader.vue.html", function() {
     var newContent = require("!!../../../../../../node_modules/css-loader/index.js!../../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"id\":\"data-v-6425d8a4\",\"scoped\":false,\"hasInlineConfig\":true}!../../../../../../node_modules/sass-loader/lib/loader.js!../../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./AvatarUploader.vue.html");
